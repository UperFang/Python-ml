...
<html lang='zh-CN'>
<head>
<title>vscode/617/converter.py · 麦叔/hard_python - 码云 Gitee.com</title>
...
<meta content='gitee.com/bigmmm/hard_python git https://gitee.com/bigmmm/hard_python.git' name='go-import'>
<meta charset='utf-8'>
<meta content='always' name='referrer'>
<meta content='码云' property='og:site_name'>
<meta content='Object' property='og:type'>
<meta content='http://gitee.com/bigmmm/hard_python/blob/master/vscode/617/converter.py' property='og:url'>
<meta content='https://gitee.com/static/images/logo_themecolor.png' itemprop='image' property='og:image'>
<meta content='vscode/617/converter.py · 麦叔/hard_python - 码云 Gitee.com' itemprop='name' property='og:title'>
...
<meta content="S9nCYmunOLnNEu+EtatZGDaqt180ELKDkcegwMFnXVA=" name="csrf-token" />

<link href="https://assets.gitee.com/assets/application-a7e3307d20037d44aa20afbd4d44b22e.css" media="all" rel="stylesheet" />
<script>
//<![CDATA[
window.gon = {};gon.locale="zh-CN";gon.sentry_dsn=null;gon.baidu_register_hm_push=null;gon.info={"controller_path":"blob","action_name":"show","current_user":false};gon.tour_env={"current_user":null,"action_name":"show","original_url":"http://gitee.com/bigmmm/hard_python/blob/master/vscode/617/converter.py","controller_path":"blob"};gon.http_clone="https://gitee.com/bigmmm/hard_python.git";gon.user_project="bigmmm/hard_python";gon.manage_branch="管理分支";gon.manage_tag="管理标签";gon.enterprise_id=0;gon.create_reaction_path="/bigmmm/hard_python/reactions";gon.ref="master";
//]]>
</script>
<script src="https://assets.gitee.com/assets/static/sentry-5.1.0-109ee3d8895a239331efcf947ba7f5d8.js"></script>
<script src="https://assets.gitee.com/assets/application-c462effdda1b3cf9f7ac8d48048a14b5.js"></script>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(event) {
    ...
    wx.config({
      ...
      timestamp: "1594954310",
      nonceStr: "5fe328985ab2214c3794eae4c6c68137",
      signature: "7ac28754ef3d98f0bba2d474136c959625bc0516",
      jsApiList: [
        'onMenuShareTimeline',
    ...
    wx.ready(function () {
      wx.onMenuShareTimeline({
        title: title, // 分享标题
        link: "https://gitee.com/bigmmm/hard_python/blob/master/vscode/617/converter.py", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: imgUrl // 分享图标
      });
...
<script>
  var can_search_in_repo = 1,
      repo = "VDBSRk1VMXFUVE5QVjBVelRtcE9iV0UzTmpObWE3NjNm",
      reponame = "bigmmm/hard_python";
...
Watch
</a><a class="ui button action-social-count" href="/bigmmm/hard_python/watchers" title="6">6
</a></span>
...
Star
</a><a class="ui button action-social-count" href="/bigmmm/hard_python/stargazers" title="14">14
</a></span>
<span class='ui basic buttons fork-container' title='无权 Fork 此仓库'>
<a class="ui button fork" href="/login" title="你必须登录后才可以fork一个仓库"><i class='iconfont icon-fork'></i>
Fork
</a><a class="ui button action-social-count disabled-style" href="/bigmmm/hard_python/members" title="5">5
</a></span>
</div>
<h2 class='git-project-title'>
<span class="project-title"><i class="project-icon iconfont icon-project-public" title="这是一个公开仓库"></i> <a class="author" href="/bigmmm" title="麦叔">麦叔</a> / <a class="repository" href="/bigmmm/hard_python" style="padding-bottom: 0px" target="" title="hard_python">hard_python</a></span><span class="project-badges"><a class="ui small label proj-language" href="/explore/all?lang=Python" target="_blank" title="主要编程语言">Python</a><style>
  .gitee-modal {
    width: 500px !important; }
</style>
</span>
<input id="project_title" name="project_title" type="hidden" value="麦叔/hard_python" />
</h2>
</div>
</div>
</div>
...
<script>
  ...
  var title_post_url = "/bigmmm/hard_python/update_import";
  var title_fork_url = "/bigmmm/hard_python/sync_fork";
  var title_project_path = "hard_python";
  var title_p_name = "hard_python";
  var title_p_id= "8152379";
  var title_description = "";
  var title_form_authenticity_token = "S9nCYmunOLnNEu+EtatZGDaqt180ELKDkcegwMFnXVA=";
...
<a class="item active" href="/bigmmm/hard_python"><i class='iconfont icon-code'></i>
代码
</a><a class="item " href="/bigmmm/hard_python/issues"><i class='iconfont icon-task'></i>
Issues
<span class='ui mini circular label'>
0
</span>
</a><a class="item " href="/bigmmm/hard_python/pulls"><i class='iconfont icon-pull-request'></i>
Pull Requests
<span class='ui mini circular label'>
1
</span>
</a><a class="item " href="/bigmmm/hard_python/attach_files"><i class='iconfont icon-annex'></i>
附件
<span class='ui mini circular label'>0</span>
</a><a class="item " href="/bigmmm/hard_python/wikis"><i class='iconfont icon-wiki'></i>
Wiki
<span class='ui mini circular label'>
0
</span>
</a><a class="item  " href="/bigmmm/hard_python/graph/master"><i class='iconfont icon-statistics'></i>
统计
...
<i class='dropdown icon'></i>
<div class='menu' style='display:none'>
<a class="item" href="/bigmmm/hard_python/pages"><img alt="Logo en" src="/static/images/logo-en.svg" />
<div class='item-title'>
Gitee Pages
</div>
</a><a class="item" href="/bigmmm/hard_python/quality_analyses?platform=sonar_qube"><img alt="Sonar mini" src="https://assets.gitee.com/assets/sonar_mini-5e1b54bb9f6c951d97fb778ef623afea.png" />
<div class='item-title'>
质量分析
</div>
</a><a class="item" href="/bigmmm/hard_python/quality_analyses?platform=codesafe"><img alt="Codesafe mini" src="https://assets.gitee.com/assets/codesafe_mini-accbe1e555e9864c552620240d10e4de.png" width="100%" />
<div class='item-title'>
奇安信代码卫士
</div>
</a><a class="item" href="/bigmmm/hard_python/gitee_scans"><img alt="Giteescan" src="https://assets.gitee.com/assets/giteescan-cd9ab4076bd751faf7e30888eb10f782.png" />
...
<script>
  ...
  $.ajax({
    url:"/bigmmm/hard_python/access/add_access_log",
    type:"GET"
  });
...
<script>
  $(function () {
    new ProjectInfoEditor({
      ...
      homepage: null,
      description: "",
      url: "/bigmmm/hard_python/update_description",
      modalHelper: Gitee.modalHelper
    })
  })
  
  if (false) {
    gon.project_new_blob_path = "/bigmmm/hard_python/new/master/vscode/617/converter.py"
    bindShowModal({
  ...
  $('#remove-no-license-message').on('click', function(){
    $.cookie("skip_repo_no_license_message_8152379", 'hide', { expires: 365 })
...
<ul>
<li>
<a href="/bigmmm/hard_python/commits/master"><i class='iconfont icon-commit'></i>
<b>46</b>
次提交
</a></li>
<li>
<a href="/bigmmm/hard_python/branches"><i class='iconfont icon-branches'></i>
<b>1</b>
个分支
</a></li>
<li>
<a href="/bigmmm/hard_python/tags"><i class='iconfont icon-tag'></i>
<b>0</b>
个标签
</a></li>
<li>
<a href="/bigmmm/hard_python/releases"><i class='iconfont icon-release'></i>
<b>0</b>
个发行版
</a></li>
<li>
<a href="/bigmmm/hard_python/contributors?ref=master"><i class='iconfont icon-collaborators'></i>
<b class='contributor-count' data-url='/bigmmm/hard_python/contributors_count?ref=master'></b>
...
<a class='item active' data-text='' data-type='http' data-url='https://gitee.com/bigmmm/hard_python.git'>HTTPS</a>
<a class='item' data-text='' data-type='ssh' data-url='git@gitee.com:bigmmm/hard_python.git'>SSH</a>
<a class='item' data-text="该仓库未启用SVN访问，请仓库管理员前往【&lt;a target='_blank' href=/bigmmm/hard_python/settings&gt;仓库设置&lt;/a&gt;】开启。" data-type='svn' data-url=''>SVN</a>
<a class='item' data-text="该仓库未启用SVN访问，请仓库管理员前往【&lt;a target='_blank' href=/bigmmm/hard_python/settings&gt;仓库设置&lt;/a&gt;】开启。" data-type='svn_ssh' data-url=''>SVN+SSH</a>
</div>
<div class='ui fluid right labeled small input download-url-panel'>
<input id="project_clone_url" name="project_clone_url" onclick="focus();select()" readonly="readonly" type="text" value="https://gitee.com/bigmmm/hard_python.git" />
...
<input id="path" name="path" type="hidden" value="vscode/617/converter.py" />
...
<a class="ui link button" href="/bigmmm/hard_python/branches">管理</a>
</div>
<div class='tab-menu-action' data-tab='tags'>
<a class="ui link button" href="/bigmmm/hard_python/tags">管理</a>
</div>
  ...
  $(function () {
    Gitee.initTabsInDropdown($('#git-project-branch').dropdown({
      ...
      action: function (text,value,el) {
        ...
        var path = $('#path').val();
        var href = ['/bigmmm/hard_python/tree', encodeURIComponent(value), path].join('/');
...
<i class='dropdown icon'></i>
<div class='menu'>
<a class="item repo-action" href="/bigmmm/hard_python/new/master/vscode/617/converter.py" id="new_file_bread" title="新建文件">新建文件
...
<a class="ui gradient button webide" href="/-/ide/project/bigmmm/hard_python/edit/master" target="_blank">Web IDE</a>
</div>
<div class='item toschina-content__hidden'>
<a class="ui gradient button repo-action" href="/bigmmm/hard_python/widget"><i class='iconfont icon-widget icon-orange'></i>
挂件
</a></div>
</div>
<script>
...
<a class="section repo-name" data-direction="back" href="/bigmmm/hard_python/tree/master" style="font-weight: bold">hard_python
</a><div class='divider'>
/
</div>
<strong>
<a class="section" data-direction="back" href="/bigmmm/hard_python/tree/master/vscode"><span class='cblue'>
vscode
</span>
</a></strong>
<div class='divider'>
...
<strong>
<a class="section" data-direction="back" href="/bigmmm/hard_python/tree/master/vscode/617"><span class='cblue'>
617
</span>
</a></strong>
<div class='divider'>
...
<span class='file_name' title='converter.py'>
converter.py
</span>
<small>551 Bytes</small>
</div>
...
<a class="ui button edit-blob" href="/bigmmm/hard_python/edit/master/vscode/617/converter.py" title="只有登陆后才可以编辑">编辑</a>
<a class="ui button web-ide" href="/-/ide/project/bigmmm/hard_python/edit/master/-/vscode/617/converter.py" target="_blank">Web IDE</a>
<a class="ui button edit-raw" href="/bigmmm/hard_python/raw/master/vscode/617/converter.py" target="_blank">原始数据</a>
<a class="ui button edit-blame" href="/bigmmm/hard_python/blame/master/vscode/617/converter.py">按行查看</a>
<a class="ui button edit-history" href="/bigmmm/hard_python/commits/master/vscode/617/converter.py">历史</a>
</div>
<script>
  "use strict";
  try {
...
<a class="commit-author-link " href="/qingkeme">轻课网</a>
<span>提交于</span>
<span class='timeago commit-date' title='2020-03-31 07:47:37 +0800'>
2020-03-31 07:47
</span>
.
<a href="/bigmmm/hard_python/commit/b02e9918e4573a571fe5ef3e0215b708b0881512">vscode</a>
</span>
</div>
</div>
...
<div class='line-numbers'><a href='#L1' id='L1'>1</a><a href='#L2' id='L2'>2</a><a href='#L3' id='L3'>3</a><a href='#L4' id='L4'>4</a><a href='#L5' id='L5'>5</a><a href='#L6' id='L6'>6</a><a href='#L7' id='L7'>7</a><a href='#L8' id='L8'>8</a><a href='#L9' id='L9'>9</a><a href='#L10' id='L10'>10</a><a href='#L11' id='L11'>11</a><a href='#L12' id='L12'>12</a><a href='#L13' id='L13'>13</a><a href='#L14' id='L14'>14</a><a href='#L15' id='L15'>15</a><a href='#L16' id='L16'>16</a><a href='#L17' id='L17'>17</a><a href='#L18' id='L18'>18</a><a href='#L19' id='L19'>19</a><a href='#L20' id='L20'>20</a><a href='#L21' id='L21'>21</a><a href='#L22' id='L22'>22</a><a href='#L23' id='L23'>23</a></div><div class="highlight"><pre class=""><div class='line' id='LC1'><span class="kn">import</span> <span class="nn">openpyxl</span>&#x000A;</div><div class='line' id='LC2'>&#x000A;</div><div class='line' id='LC3'><span class="nb">file</span> <span class="o">=</span> <span class="s">"file.xlsx"</span>&#x000A;</div><div class='line' id='LC4'><span class="n">wb</span> <span class="o">=</span> <span class="n">openpyxl</span><span class="p">.</span><span class="n">load_workbook</span><span class="p">(</span><span class="nb">file</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC5'><span class="n">sheet</span> <span class="o">=</span> <span class="n">wb</span><span class="p">.</span><span class="n">active</span>&#x000A;</div><div class='line' id='LC6'><span class="n">row</span> <span class="o">=</span> <span class="n">sheet</span><span class="p">.</span><span class="n">max_row</span>&#x000A;</div><div class='line' id='LC7'><span class="n">col</span> <span class="o">=</span> <span class="n">sheet</span><span class="p">.</span><span class="n">max_column</span>&#x000A;</div><div class='line' id='LC8'>&#x000A;</div><div class='line' id='LC9'><span class="n">sheet2</span> <span class="o">=</span> <span class="n">wb</span><span class="p">.</span><span class="n">create_sheet</span><span class="p">(</span><span class="n">index</span><span class="o">=</span><span class="mi">2</span><span class="p">,</span> <span class="n">title</span><span class="o">=</span><span class="s">"Converted Data"</span><span class="p">)</span>  <span class="c1"># 创建一个新的表</span>&#x000A;</div><div class='line' id='LC10'>&#x000A;</div><div class='line' id='LC11'><span class="n">row_count</span> <span class="o">=</span> <span class="mi">1</span>&#x000A;</div><div class='line' id='LC12'><span class="k">print</span><span class="p">(</span><span class="s">'started'</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC13'>&#x000A;</div><div class='line' id='LC14'><span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="n">row</span><span class="o">+</span><span class="mi">1</span><span class="p">):</span>&#x000A;</div><div class='line' id='LC15'>    <span class="n">keywords</span> <span class="o">=</span> <span class="n">sheet</span><span class="p">.</span><span class="n">cell</span><span class="p">(</span><span class="n">i</span><span class="p">,</span> <span class="n">col</span><span class="p">).</span><span class="n">value</span>&#x000A;</div><div class='line' id='LC16'>    <span class="k">for</span> <span class="n">k</span> <span class="ow">in</span> <span class="n">keywords</span><span class="p">.</span><span class="n">split</span><span class="p">(</span><span class="s">';'</span><span class="p">):</span>&#x000A;</div><div class='line' id='LC17'>        <span class="k">for</span> <span class="n">j</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="n">col</span><span class="o">-</span><span class="mi">1</span><span class="p">):</span>&#x000A;</div><div class='line' id='LC18'>            <span class="n">sheet2</span><span class="p">.</span><span class="n">cell</span><span class="p">(</span><span class="n">row_count</span><span class="p">,</span> <span class="n">j</span><span class="p">).</span><span class="n">value</span> <span class="o">=</span> <span class="n">sheet</span><span class="p">.</span><span class="n">cell</span><span class="p">(</span><span class="n">i</span><span class="p">,</span> <span class="n">j</span><span class="p">).</span><span class="n">value</span>&#x000A;</div><div class='line' id='LC19'>        <span class="n">sheet2</span><span class="p">.</span><span class="n">cell</span><span class="p">(</span><span class="n">row_count</span><span class="p">,</span> <span class="n">j</span><span class="p">).</span><span class="n">value</span> <span class="o">=</span> <span class="n">k</span>&#x000A;</div><div class='line' id='LC20'>        <span class="n">row_count</span> <span class="o">+=</span> <span class="mi">1</span>&#x000A;</div><div class='line' id='LC21'>&#x000A;</div><div class='line' id='LC22'><span class="n">wb</span><span class="p">.</span><span class="n">save</span><span class="p">(</span><span class="nb">file</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC23'><span class="k">print</span><span class="p">(</span><span class="s">'finished'</span><span class="p">)</span>&#x000A;</div></pre></div></div>
</div>
<script>
...
<input id="comment_path" name="comment_path" type="hidden" value="vscode/617/converter.py" />
...
<script>
  ...
  $(function(){
    ...
    function loadComments () {
      ...
      $tipLoading.show();
      $.ajax({
        url: '/bigmmm/hard_python/comment_list',
        data: {
          page: page,
          path: path
        },
...
<script>
  (function() {
    ...
    donateModal = new ProjectDonateModal({
      ...
      alipayUrl: '/bigmmm/hard_python/alipay',
      wepayUrl: '/bigmmm/hard_python/wepay',
      nameIsBlank: '名称不能为空',
...
<div class='extension https'>https://gitee.com/bigmmm/hard_python.git</div>
<div class='extension ssh'>git@gitee.com:bigmmm/hard_python.git</div>
<div class='extension namespace'>bigmmm</div>
<div class='extension repo'>hard_python</div>
<div class='extension name'>hard_python</div>
<div class='extension branch'>master</div>
</div>

<script>
  $(function() {
    GitLab.GfmAutoComplete.dataSource = "/bigmmm/hard_python/autocomplete_sources"
...
<script>
  Gitee.initSideToolbar({
    hasComment: true,
    commentUrl: '/bigmmm/hard_python#tree_comm_title'
  })
</script>
<script>
